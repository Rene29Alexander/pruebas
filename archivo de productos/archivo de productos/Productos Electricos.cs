...
namespace manejoArchivos
{
    class Archivos
    {
        ...
        {
            string path = @"C:\Users\alexi\OneDrive\Escritorio\Proyectos\archivo de productos\Archivos.txt";
            return path;
        }
        ...
        {
            string[] lines = System.IO.File.ReadAllLines(@"C:\Users\alexi\OneDrive\Escritorio\Proyectos\archivo de productos\Archivos.txt");
